  ...
  return (
    <div className="inline-flex justify-center gap-1 justify-self-end relative">
      {page > 1 && (
        <Link
          href={String(page - 1)}
          className="flex size-8 items-center justify-center rounded border border-gray-100 bg-white text-gray-900 rtl:rotate-180 absolute -left-10 top-0"
        >
      ...
      {page < total / 10 && (
        <Link
          href={String(page + 1)}
          className="inline-flex size-8 items-center justify-center rounded border border-gray-100 bg-white text-gray-900 rtl:rotate-180 absolute -right-10 top-0"
        >
